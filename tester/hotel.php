...
<body>
	...
	<div id="main-wrapper">
							...
							<div class="card bg-light-success rounded-3 p-4 m-0">
								<div class="card-body py-3 px-1">
									...
									<div class="d-flex justify-content-between align-items-center">
										...
										<a href="home-hotel.php#" class="nav-link text-success"><i class="fa-solid fa-arrow-right"></i></a>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="card bg-light-purple rounded-3 p-4 m-0">
								<div class="card-body py-3 px-1">
									...
									<div class="d-flex justify-content-between align-items-center">
										...
										<a href="home-hotel.php#" class="nav-link text-purple"><i class="fa-solid fa-arrow-right"></i></a>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="card bg-light-danger rounded-3 p-4 m-0">
								<div class="card-body py-3 px-1">
									...
									<div class="d-flex justify-content-between align-items-center">
										...
										<a href="home-hotel.php#" class="nav-link text-danger"><i class="fa-solid fa-arrow-right"></i></a>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="card bg-light-warning rounded-3 p-4 m-0">
								<div class="card-body py-3 px-1">
									...
									<div class="d-flex justify-content-between align-items-center">
										...
										<a href="home-hotel.php#" class="nav-link text-warning"><i class="fa-solid fa-arrow-right"></i></a>
									</div>
								</div>
							</div>
						</div>
				...
				<div class="row align-items-center justify-content-between mb-3">
					...
					<div class="col-4">
						<div class="text-end grpx-btn">
							<a href="home-hotel.php#" class="btn btn-light-primary btn-md fw-medium">More<i
						...
						<div class="main-carousel cols-3 dots-full">
							...
							<div class="carousel-cell">
								<div class="pop-touritem">
									<a href="home-hotel.php#" class="card rounded-3 border br-dashed m-0">
					...
					<div class="col-xl-12 col-lg-12 col-md-12 p-0">
						<div class="main-carousel cols-4 dots-full">
							...
							<div class="carousel-cell">
								<div class="destination-blocks bg-white p-2 rounded border br-dashed">
									<div class="destination-blocks-pics p-1">
										<a href="home-hotel.php#"><img src="assets/img/city/c-6.png" class="img-fluid rounded" alt=""></a>
									</div>
							...
							<div class="carousel-cell">
								<div class="destination-blocks bg-white p-2 rounded border br-dashed">
									<div class="destination-blocks-pics p-1">
										<a href="home-hotel.php#"><img src="assets/img/city/c-5.png" class="img-fluid rounded" alt=""></a>
									</div>
									<div class="destination-blocks-captions">
										<div class="touritem-flexxer text-center p-3">
											<h4 class="city fs-5 m-0 fw-bold">
							...
							<div class="carousel-cell">
								<div class="destination-blocks bg-white p-2 rounded border br-dashed">
									<div class="destination-blocks-pics p-1">
										<a href="home-hotel.php#"><img src="assets/img/city/c-4.png" class="img-fluid rounded" alt=""></a>
									</div>
									<div class="destination-blocks-captions">
										<div class="touritem-flexxer text-center p-3">
											<h4 class="city fs-5 m-0 fw-bold">
								...
								<div class="row align-items-center justify-content-between">
									...
									<div class="col-xl-4 col-lg-4 col-md-5 col-sm-12">
										<div class="appLink-buttons text-md-end mt-md-0 mt-4">
											<div class="app-wrap">
												<a href="home-hotel.php#" class="d-inline-flex">
													<div
			...
			<div class="container">
				...
				<div class="row justify-content-center gy-4 gx-3">
					...
					<div class="col-xl-3 col-lg-4 col-md-4 col-sm-6">
						<a class="recommend-module-card" href="home-hotel.php#">
							<div class="bokker-bg-full" style="background:url(assets/img/city/c-8.png)no-repeat;"></div>
							<div class="bokker-content">
								<div class="bokker-content-text fs-4 lh-base">Discover great deals on hotels around the world</div>
								<div class="bokker-content-button">Go Now</div>
							</div>
						</a>
					</div>
			...
			<div class="container">
				...
				<div class="row justify-content-center g-4">
					...
					<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
						<div class="blogGrid-wrap d-flex flex-column h-100">
							<div class="blogGrid-pics">
								<a href="home-hotel.php#" class="d-block"><img src="assets/img/blog-1.jpg" class="img-fluid rounded" alt="Blog image"></a>
							</div>
							<div class="blogGrid-caps pt-3">
								<div class="d-flex align-items-center mb-1"><span
										class="label text-success bg-light-success">Destination</span></div>
								<h4 class="fw-bold fs-6 lh-base"><a href="home-hotel.php#" class="text-dark">Make Your Next Journey Delhi To Paris in
								...
								<a class="text-primary fw-medium" href="home-hotel.php#">Read More<i class="fa-solid fa-arrow-trend-up ms-2"></i></a>
							</div>
						</div>
					</div>
					...
					<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
						<div class="blogGrid-wrap d-flex flex-column h-100">
							<div class="blogGrid-pics">
								<a href="home-hotel.php#" class="d-block"><img src="assets/img/blog-2.jpg" class="img-fluid rounded" alt="Blog image"></a>
							</div>
							<div class="blogGrid-caps pt-3">
								<div class="d-flex align-items-center mb-1"><span
					...
					<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
						<div class="blogGrid-wrap d-flex flex-column h-100">
							<div class="blogGrid-pics">
								<a href="home-hotel.php#" class="d-block"><img src="assets/img/blog-3.jpg" class="img-fluid rounded" alt="Blog image"></a>
							</div>
							<div class="blogGrid-caps pt-3">
								<div class="d-flex align-items-center mb-1"><span
		...
		<div class="position-relative bg-cover py-5 bg-dark" style="background:url(assets/img/bg2.png)no-repeat;">
			<div class="container">
				<div class="row align-items-center justify-content-between">
				...
				<div class="container">
					<div class="row align-items-center justify-content-between">
						...
						<div class="col-xl-6 col-lg-6 col-md-6">
							<p class="mb-0">© 2023 EagleWays Travel & Tours Design by Themezhub.</p>
						</div>

						<div class="col-xl-6 col-lg-6 col-md-6">
							<ul class="p-0 d-flex justify-content-start justify-content-md-end text-start text-md-end m-0">
								<li><a href="home-hotel.php#">Terms of services</a></li>
								<li class="ms-3"><a href="home-hotel.php#">Privacy Policies</a></li>
								<li class="ms-3"><a href="home-hotel.php#">Cookies</a></li>
							</ul>
						</div>
			...
			<div class="modal-dialog modal-dialog-centered login-pop-form" role="document">
				<div class="modal-content" id="loginmodal">
					<div class="modal-header">
						...
						<a href="home-hotel.php#" class="text-muted fs-4" data-bs-dismiss="modal" aria-label="Close"><i
					...
					<div class="modal-body">
						...
						<div class="social-login py-4 px-2">
							<ul class="row align-items-center justify-content-between g-3 p-0 m-0">
								<li class="col"><a href="home-hotel.php#" class="square--60 border br-dashed rounded-2 full-width"><i
											class="fa-brands fa-facebook color--facebook fs-2"></i></a></li>
								<li class="col"><a href="home-hotel.php#" class="square--60 border br-dashed rounded-2"><i
					...
					<div class="modal-footer align-items-center justify-content-center">
						<p>Don't have an account yet?<a href="https://shreethemes.net/EagleWays Travel & Tours-live/EagleWays Travel & Tours/signup.php" class="text-primary fw-medium ms-1">Sign Up</a></p>
					</div>
				</div>
			</div>
		</div>
				  ...
				  <div class="suggestedCurrencylist-wrap mb-4">
					...
					<div class="suggestedCurrencylists">
					  <ul
						...
						<li class="col">
						  <a class="selectCurrency" href="home-hotel.php#">
						...
						<li class="col">
						  <a class="selectCurrency active" href="home-hotel.php#">
				  ...
				  <div class="suggestedCurrencylist-wrap mb-4">
					...
					<div class="suggestedCurrencylists">
					  <ul
						...
						<li class="col">
						  <a class="selectCountry" href="home-hotel.php#">
						...
						<li class="col">
						  <a class="selectCountry active" href="home-hotel.php#">
		...
		<a id="back2Top" class="top-scroll" title="Back to top" href="home-hotel.php#"><i class="fa-solid fa-sort-up"></i></a>
