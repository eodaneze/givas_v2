...
<body>
    <div class='container'>
        ...
        <div class='content'>
            ...
            <p>Thank you for listing your product in Givas Community. Unfortunately, after a thorough review, we regret to inform you that your product with the name: $pname did not meet the required standards for approval.</p>

            <h2>Reasons for Rejection:</h2>
            <p>$message</p>

            <p>To proceed with your product listing, we kindly request that you follow all the instructions that where outlined in the publish product section of your givas dashboard</p>
