 <?php
     if($payment_option == 'bank'){
        ...
        $payment_details = "
            <p><strong>Payment Option:</strong> Bank</p> 
        ...
        $payment_details = "
            <p><strong>Payment Option:</strong> Crypto</p> 
            <p><strong>Wallet Address:</strong> $wallet_address</p><br>
        ";
     }
     $body = "
         <!DOCTYPE html>
...
<body>
    <div class='container'>
        ...
        <div class='content'>
            ...
            <p>We have received your payout request as a GIVAS affiliate. 🎉</p><br>

             <p>Here are the details of your request:</p>
              <p><strong>Amount:</strong> $formatted_amount $currency</p>
              $payment_details

            <p>Your account will be credited on the next payout day — <strong>Saturday</strong>.</p>
            
             <p>Keep promoting and earning with GIVAS!</p>
