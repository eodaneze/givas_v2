  ...
  <body>
    <section class='main'>
      ...
      <div class='content container'>
        ...
        <br />
        <p>As part of the registration process, we’ve provided you with a coupon code that you’ll need to complete your registration. Please find your coupon code below:</p><br /><br/>

        <p><strong>Please Note:</strong> This coupon code will only be used to create $no_account accounts in Givas</p><br/><br/>
