  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="staticBackdropLabel">Vendor Payout</h1>
           ...
           <form id="payoutForm">
                <div class="row">
                    ...
                    <div class="col-lg-12 mb-3">
                        ...
                        <input type="text" value="$<?=number_format($vendor_total_sales, 2)?>"  class="form-control p-3" readonly>
                    </div>
...
document.getElementById('payoutForm').addEventListener('submit', function(e){
    ...
    setTimeout(() => {
        ...
        fetch(`./inc/vendor_process_payout`, {
            method: 'POST',
            body: formData
        })
        .then(res => res.json())
